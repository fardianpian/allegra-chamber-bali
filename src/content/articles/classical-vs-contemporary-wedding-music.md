...
faq:
  ...
  - question: 'Can pop or contemporary songs be arranged for a string quartet or piano?'
    answer: 'Yes. Most contemporary songs can be arranged for any of our formations — see our custom arrangement guide for what that process involves and what to send us when you request a song.'
  - question: 'Is contemporary music appropriate for a formal ceremony?'
...
## What "Classical" and "Contemporary" Actually Mean for a Chamber Ensemble

"Classical" and "contemporary" describe two different sources for the same repertoire, not two different sounds. Classical pieces were originally written for piano, strings, or orchestra — pieces like Canon in D or Air on the G String need no adaptation to work on a chamber ensemble, because chamber instruments are what they were composed for. Contemporary pieces were written for other instruments entirely — a pop vocal, a film score, a guitar — and are arranged for piano and strings before a live ensemble can play them. Both end up sounding like they belong in the same ceremony once they're arranged, which is part of why most couples end up mixing the two rather than picking one.

## When Classical Pieces Fit Best

Classical pieces tend to fit best for the prelude and processional — moments where a steady, familiar structure helps set the tone before the ceremony itself begins. Pieces such as Canon in D, Clair de Lune, or Ave Maria carry an established, easily recognisable character that reads as formal without needing lyrics to do the work. They also suit ceremonies with a more traditional structure, where a recognisable classical piece signals the moment clearly to guests. None of this rules out a classical prelude followed by a completely different tone later in the day — it's a fit for a moment, not a fixed style for the whole ceremony.
...
Most ceremonies use both styles rather than committing to one. A common structure is a classical prelude while guests are seated, a contemporary arrangement — often the couple's own song — for the processional, and something brighter for the recessional, whether that's classical or contemporary. There's no rule requiring consistency across the ceremony's different moments; what matters is that each piece fits the tone of that specific moment. Our [repertoire page](/repertoire/) lists real pieces across both classical and contemporary categories if you want to browse before deciding.

## How to Tell Us What You're Picturing If You're Not Sure

You don't need to know the terminology to get started — a reference is usually more useful than a description. Naming a film, an artist, or even "something like what played at a wedding we loved" gives us enough to work from. If you already have a song in mind that isn't originally written for chamber instruments, it doesn't need to already exist as sheet music for one — that's what a [custom arrangement](/journal/custom-wedding-music-arrangement/) is for. Share what you're picturing when you [get in touch](/contact/), and we'll help you shape a program that mixes styles in a way that feels intentional rather than arbitrary.
